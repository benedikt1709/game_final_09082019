...
class startScreen extends Phaser.Scene {
    ...
    preload() {
        ...
        this.add.bitmapText(210, 150, "pixFont", 'Press Spacebar to jump.', 18);
        this.add.bitmapText(125, 190, "pixFont", 'Reinhold can doublejump and jump from walls...', 18);
        this.add.bitmapText(160, 300, "pixFont", 'Press "ENTER" to start', 32)
        };
...
class playGame extends Phaser.Scene {
    ...
    create() {
        ...
        this.input.keyboard.on("keydown_SPACE", this.buttonInput, this);
    ...
    update() {
        ...
        if (this.lives === 0) {
            ...
            this.replayLabel = this.add.bitmapText(320, 280, "pixFont", "PRESS ENTER", 32);
            this.replayLabel.text = "PRESS ENTER TO RESTART"
    ...
    endGame() {
        ...
        this.add.bitmapText(150, 350, "pixFont", 'PRESS ENTER TO RESTART', 32);
        this.input.keyboard.on("keydown_ENTER", this.restartGame, this);
    }
}
